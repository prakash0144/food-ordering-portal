...
const EmptyCart = () => {
    ...
    return (
        <div className="empty-cart-container text-center" style={cartContainer}>
            ...
            <button className="btn" onClick={handleCartClick} style={btnstyle}>GO TO HOME <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-soup" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
